...
const TOOLS: any[] = [
  ...
  { name: "ems_create_product",  description: "Create a new product in Sentinel EMS.", inputSchema: { type: "object", properties: { name: { type: "string" }, version: { type: "string" }, description: { type: "string" }, namespace_name: { type: "string", description: "Namespace name (e.g. 'Default')" }, feature_uids: { type: "array", items: { type: "string" }, description: "Feature UIDs to attach at creation time" }, feature_names: { type: "array", items: { type: "string" }, description: "Feature names to attach at creation time" } }, required: ["name"] } },
